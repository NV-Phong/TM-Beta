...
{
    options.DefaultScheme = "TaskMange"; // Sử dụng scheme "TaskMange" làm scheme mặc định
})
.AddCookie("TaskMange", options => // Sử dụng scheme "TaskMange" cho cookie authentication
{
    options.Cookie.Name = "TaskMange";
